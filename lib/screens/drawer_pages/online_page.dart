...
// import 'package:beatflirt/screens/chat_screen.dart';
...
//               (context, index) {
//             final user = users[index % users.length];
//             return _buildOnlineCard(context, user);
//           },
//           childCount: 12,
//         ),
//       ),
...
//   Widget _buildOnlineCard(BuildContext context, UserListItem user) {
//     return GestureDetector(
//       onTap: () {
//         Navigator.push(
//           context,
//           MaterialPageRoute(
//             builder: (context) => ChatScreen(user: user, recipientId: '', recipientName: '',),
//           ),
//         );
//       },
//       child: Container(
