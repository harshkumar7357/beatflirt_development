...
// //
// // class NewMembersPage extends ConsumerWidget {
...
// //             _buildSectionHeader(
// //               'Fresh Faces',
// //               'Explore our newest community members',
// //             ),
// //             _buildMembersGrid(state.users, ref),
// //           ],
...
// //       },
// //           onChanged: (val) {
// //             ref.read(userListProvider('new_members').notifier).searchUsers(val);
// //           },
// //           style: const TextStyle(color: Colors.white, fontSize: 13),
// //           decoration: InputDecoration(
// //             hintText: "Search name or 12-digit ID...",
// //             hintStyle: TextStyle(color: Colors.white.withValues(alpha: 0.3)),
// //             prefixIcon: const Icon(Icons.search, color: Colors.pinkAccent, size: 18),
...
// //   }
// //
// //   Widget _buildMembersGrid(List<UserListItem> users, WidgetRef ref) {
// //     if (users.isEmpty)
...
// //           return _buildMemberCard(context, user, ref);
...
// //                     Text(
// //                       "ID: ${user.id.length > 12 ? user.id.substring(user.id.length - 12) : user.id}",
// //                       style: TextStyle(
...
// //                                 await ref
// //                                     .read(
// //                                       userListProvider('new_members').notifier,
// //                                     )
// //                                     .sayHi(user.id);
// //                                 ScaffoldMessenger.of(context).showSnackBar(
// //                                   SnackBar(
// //                                     content: Text('Hi sent to ${user.name}!'),
// //                                   ),
// //                                 );
// //                               } catch (e) {
// //                                 ScaffoldMessenger.of(context).showSnackBar(
...
// //                               ScaffoldMessenger.of(context).showSnackBar(
// //                                 SnackBar(
// //                                   content: Text('Failed to favorite: $e'),
// //                                 ),
// //                               );
// //                             }
// //                           },
...
// import '../../core/utils/user_card.dart';
...
//   @override
//   _NewMembersScreenState createState() => _NewMembersScreenState();
// }

// class _NewMembersScreenState extends State<NewMembersScreen> {
//   final ApiService _apiService = ApiService();
//   late Future<NewUserResponse?> _membersFuture;

//   @override
//   void initState() {
//     super.initState();
//     _membersFuture = _apiService.fetchNewMembers();
//   }

//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       backgroundColor: const Color(0xFFFDEEF4), // Light pink background
//       appBar: AppBar(
//         leading: IconButton(
...
//         title: const Text(
//           'BeatFlirt',
//           style: TextStyle(color: Color(0xFF2D0A26), fontWeight: FontWeight.bold),
//         ),
//         actions: [
//           IconButton(
...
//           ),
//           IconButton(
//             icon: const Icon(Icons.logout, color: Color(0xFF2D0A26)),
//             onPressed: () {},
//           ),
...
//       body: Row(
//         children: [
//           // Simulated Sidebar (optional based on user project structure)
//           // Container(
//           //   width: 80,
//           //   color: const Color(0xFF2D0A26),
//           //   child: Column(
//           //     children: const [
//           //       SizedBox(height: 20),
...
//                     children: [
//                       Expanded(
//                         child: FutureBuilder<NewUserResponse?>(
//                           future: _membersFuture,
//                           builder: (context, snapshot) {
//                             String count = snapshot.data?.totalUserCount ?? '...';
//                             return Text(
//                               'New Members ($count)',
//                               overflow: TextOverflow.ellipsis,
//                               style: const TextStyle(
...
//                       ),
//                       IconButton(
//                         icon: const Icon(Icons.tune, color: Color(0xFF2D0A26)),
//                         onPressed: () {},
//                       ),
//                     ],
//                   ),
...
//                           gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
//                             crossAxisCount: 4, // Matches screenshot 4 items per row
...
//                           itemBuilder: (context, index) {
//                             return UserCard(user: members[index]);
//                           },
//                         );
//                       },
//                     ),
...
class _NewMembersScreenState extends State<NewMembersScreen> {
  ...
  Widget _buildHeader(BuildContext context) {
    ...
    return Padding(
      ...
      padding: const EdgeInsets.fromLTRB(26, 5, 26, 4),
